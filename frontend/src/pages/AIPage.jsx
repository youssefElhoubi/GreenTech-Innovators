...
import { PREDICTIONS_DATA } from "../data/predictions";


const groupedByDay = PREDICTIONS_DATA.reduce((acc, event) => {
    ...
    <div className="page-content active">
      ...
      <div className="section-card ai-section">
       ...
       <div className="calendar-view">
         {Object.entries(groupedByDay).map(([key, events], index) => (
           <div key={index} className="calendar-day">
             ...
             <div className="calendar-day-events">
               {events.map((prediction, i) => (
                 <div key={i} className={`calendar-event event-${prediction.eventType}`}>
                   <div className="calendar-event-time">{prediction.city}</div>
                   <div className="calendar-event-title">
                     {getEventIcon(prediction.eventType)} {formatTitle(prediction.predictionTitle)}
                   </div>
                   <div className="calendar-event-location">{prediction.city}</div>
                   <div className="calendar-event-confidence">ML: {prediction.confidence}%</div>
                 </div>
               ))}
             </div>
           </div>
